...
#RUSTC_TARGET_NAME = armv7-unknown-linux-gnueabihf
...
LIBRESPOT_CARGO_ENV += CARGO_TARGET_ARMV7_UNKNOWN_LINUX_GNUEABIHF_LINKER=$(TARGET_CROSS)gcc
#LIBRESPOT_CARGO_ENV += CARGO_TARGET_ARMV7_UNKNOWN_LINUX_GNUEABIHF_LINKER=$(TARGET_CC)
